    ...
    Je = {
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(e, je.sc())
          : ke.pageXOffset || Ee[r] || Me[r] || Ae[r] || 0;
      }),
    },
    je = {
      s: n,
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(Je.sc(), e)
          : ke.pageYOffset || Ee[n] || Me[n] || Ae[n] || 0;
      }),
    };
  (Je.op = je), (k.cache = 0);
  var P =
      ...
      function Ne() {
        ...
        T && (r || n) && T(se, e, t, ve, me),
          ...
          n &&
            ...
            (ce = se.deltaY),
            (me[0] = me[1] = me[2] = 0)),
          (ne || re) && (X && X(se), re && (h(se), (re = !1)), (ne = !1)),
          oe && !(oe = !1) && Z && Z(se),
          ie && (W(se), (ie = !1)),
          (ee = 0);
      }
      ...
      (te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed &&
              (se._vx.reset(), se._vy.reset(), B(R ? n : be, ze[1], Qe, !0)),
        ...
        ct && te.sort(),
          ...
          Bt.forEach(function (e) {
            return (
              ...
              e.setPositions(
                e.start,
                Math.max(e.start + 1, Ga(e.scroller, e._dir))
              )
            );
          }),
    ...
    U = function _updateAll(e) {
      if (!pt || 2 === e) {
        ...
        if (
          ...
          (G = i),
          n &&
            (vt && !st && 400 < r - vt && ((vt = 0), H('scrollEnd')),
            (ot = w),
            (w = r)),
          zt < 0)
        ) {
    ...
    te =
      ((ScrollTrigger.prototype.init = function init(_, T) {
        if (
          ...
          var k,
            ...
            $,
            o,
            Q = (_ = eb(Ia(_) || Ka(_) || _.nodeType ? { trigger: _ } : _, Ot))
              .onUpdate,
            Z = _.toggleClass,
            a = _.id,
            ee = _.onToggle,
          ...
          if (
            ...
            (ie = !0 === ie ? ne : I(ie)),
            Ia(Z) && (Z = { targets: ne, className: Z }),
            ie &&
              (!1 === oe ||
                oe === Pt ||
                (oe = !(!oe && 'flex' === cb(ie.parentNode).display) && Et),
              (Se.pin = ie),
          ...
          (Se.previous = function () {
            ...
            (Se.revert = function (e, t) {
              ...
              r !== Se.isReverted &&
                (r &&
                  (Se.scroll.rec ||
                    (!at && !pt) ||
                    ((Se.scroll.rec = Me()), pt && Me(0)),
                  (U = Math.max(Me(), Se.scroll.rec || 0)),
                  (K = Se.progress),
                  (q = T && T.progress())),
                C &&
                  [C, O, B, D].forEach(function (e) {
              ...
              if ((!at && Se.enabled) || t)
                if (ie && e && vt) mb(ScrollTrigger, 'scrollEnd', Eb);
                  ...
                  for (
                    Ja(y) && (y = y(Se)),
                      M =
                        $b(y, ne, d, ge, Me(), C, B, Se, p, we, me, g, fe) ||
                        (ie ? -0.001 : 0),
                      Ja(v) && (v = v(Se)),
                      Ia(v) &&
                        !v.indexOf('+=') &&
                  ...
                  if (
                    ...
                    (r = cb(ie)),
                      ...
                      (c = me && J(be, o ? Je : je)()),
                      oe &&
                        (((W = [oe + ge.os2, z + b + At]).t = R),
                        (S = oe === Et ? gb(ie, ge) + z + b : 0) &&
                          W.push(ge.d, S + At),
                        Lt(W),
                        me && Me(U)),
                      me &&
                  ...
                  f &&
                    ...
                    (Se.end = A),
                    (E = P = Me()),
                    fe || pt || (E < U && Me(U), (Se.scroll.rec = 0)),
                    Se.revert(!1, !0),
                    G &&
                      ((Ee = -1), Se.isActive && Me(M + z * K), G.restart(!0)),
                    (at = 0),
                    T &&
                      he &&
                      (T._initted || q) &&
              ...
              if (!fe || r || e) {
                ...
                if (
                  ...
                  !ce || k.tween || at || ht || G.restart(!0),
                    Z &&
                      (s || (le && d && (d < 1 || !dt))) &&
                      nt(Z.targets).forEach(function (e) {
            ...
            (Se.disable = function (e, t) {
              if (
                ...
                G && (G.pause(), k.tween && k.tween.kill() && (k.tween = 0)),
                !ve)
              ) {
      ...
      (ScrollTrigger.disable = function disable(t, r) {
        ...
        for (var e = 0; e < k.length; e += 3)
          ob(nb, k[e], k[e + 1]), ob(nb, k[e], k[e + 2]);
      }),
      (ScrollTrigger.enable = function enable() {
        if (
          ...
          (mt = 1),
            ...
            (C =
              P.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent)),
            mb(qe, 'wheel', zb),
            (s = [qe, et, tt, rt]),
            Ge.matchMedia
          ...
          for (
            ...
            ob(nb, k[t], k[t + 1]), ob(nb, k[t], k[t + 2]);
        }
      }),
